...
async function main() {
  ...
  const daysOfWeek = [
    { day: 0, name: "Sunday", available: false },
  ...
  for (const { day, available } of daysOfWeek) {
    await prisma.availability.upsert({
      where: { stylistId_dayOfWeek: { stylistId: null, dayOfWeek: day } },
      update: {},
      create: {
        dayOfWeek: day,
        startTime: "09:00",
        endTime: available ? (day === 6 ? "17:00" : "18:00") : "09:00",
        isAvailable: available,
      },
    });
  }
  console.log("✅ Default availability set (Mon-Sat 9am-6pm, Sat 9am-5pm)");
  ...
  await prisma.settings.upsert({
    ...
    create: {
      ...
      salonPhone: "+44 7700 900000",
      salonAddress: "123 High Street, London, UK",
      bookingBuffer: 30,
